...
US_INVERSE = {
    ...
    "QID":  {"name": "나스닥100 인버스 2x", "leverage": 2, "underlying": "나스닥100"},
    "SQQQ": {"name": "나스닥100 인버스 3x", "leverage": 3, "underlying": "나스닥100"},
    # S&P500 인버스
    "SH":   {"name": "S&P500 인버스 1x", "leverage": 1, "underlying": "S&P500"},
    "SDS":  {"name": "S&P500 인버스 2x", "leverage": 2, "underlying": "S&P500"},
    "SPXU": {"name": "S&P500 인버스 3x", "leverage": 3, "underlying": "S&P500"},
    # 다우 인버스
...
# 한국 인버스 ETF (코스피200/코스닥150 하락 베팅)
KR_INVERSE = {
    "114800.KS": {"name": "KODEX 인버스", "leverage": 1, "underlying": "코스피200"},
    "252670.KS": {"name": "KODEX 200선물인버스2X (곱버스)", "leverage": 2, "underlying": "코스피200"},
    "251340.KS": {"name": "KODEX 코스닥150선물인버스", "leverage": 1, "underlying": "코스닥150"},
    "291630.KS": {"name": "KODEX 코스닥150선물인버스2X", "leverage": 2, "underlying": "코스닥150"},
    "252710.KS": {"name": "TIGER 200선물인버스2X", "leverage": 2, "underlying": "코스피200"},
